...
//1.Create Function and it should be end and it should be listen using port Number


// http.createServer((request,response)=>{
//     response.write('This is my First Program')
//     response.end();
// }).listen(8000)
...
// response.write('i have write using New function')
// response.end();
// }
